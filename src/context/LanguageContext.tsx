...
const en: Record<string, string> = {
    ...
    svc_cat_import: 'Import Aluminium Profile',
    svc_cat_local: 'Local Aluminium Profile',
    svc_cat_glass: 'Structural & Decorative Glass',
    svc_cat_acp: 'Aluminium Composite Panel',
    svc_cat_acc: 'Aluminium Accessories',
    svc_cat_rail: 'Handrails',
    svc_cat_steel: 'Stainless Steel',
...
const am: Record<string, string> = {
    ...
    // Hero
    hero_tag: 'በኢትዮጵያ ዋነኛ የአሉሚኒየም አቅራቢ',
    hero_title: 'ለዘመናዊ ሕንፃ ዲዛይን — ትክክለኛ አሉሚኒየምና መስታወት',
    hero_subtitle: 'ከፍተኛ ጥራት ያለው ከውጭ የሚገቡ እና በአካባቢያችን የሚሠሩ አሉሚኒየም ፕሮፋይሎችን፣ የሕንፃ መስታወትን፣ ACP ፓናሎችን እና ልዩ ተጓዳኝ ዕቃዎችን ለሁሉም ሰሪዎች እና ተቋራጮች እናቀርባለን።',
    hero_cta_products: 'ምርቶቻችንን ይመልከቱ',
    hero_cta_gallery: 'የፎቶ ማዕከል',

    // About
    about_eyebrow: 'ታሪካችን',
    about_title: 'በጥሩ ሰራ የታወቅን እና በኢትዮጵያ የተወደድን።',
    about_desc1: 'KS Aluminum Works and Trade PLC የተቋቋመው አንድ ዓላማ ይዞ ነው፦ ዓለም አቀፍ ደረጃ ያላቸውን አሉሚኒየም ምርቶችን ለኢትዮጵያ የሕንፃ ዘርፍ ማቅረብ። ከመስታወት ፕሮፋይሎች እስከ ACP ፓናሎች፣ ሁሉም ምርቶቻችን ከአንድ ምንጭ ያገኛሉ።',
    about_desc2: 'ዋና ጽሕፈት ቤታችን ቢሾፍቱ (ደብረ ዘይት) ሲሆን፣  ዓለም አቀፍ ቁሳቁሶችን ከአካባቢ ልምድ ጋር አዋህዶ ትክክለኛ ምርቶችን በወቅቱ ያቀርባል።',
    about_stat_years: '+7 ዓመታት',
    about_stat_years_label: 'የታመነ አገልግሎት',
    about_stat_products: '50+',
    about_stat_products_label: 'የምርት ዓይነቶች',
    about_stat_clients: '200+',
    about_stat_clients_label: 'የተጠናቀቁ ፕሮጀክቶች',
    about_cta: 'ስለ እኛ የበለጠ',

    // Services
    svc_eyebrow: 'የምናቀርበው አገልግሎት',
    svc_title: 'KS ALUMINUM WORKS AND TRADE PLC',
    svc_tagline: 'ከፍተኛ ጥራት ያለው ከውጭ የሚገቡ እና አካባቢያዊ አሉሚኒየም ፕሮፋይሎችን፣ የሕንፃ መስታወትን፣ ACP ፓናሎችን እና ተጓዳኝ ዕቃዎችን ከአንድ ቦታ ያገኛሉ።',
    svc_cta_title: 'ልዩ ዝርዝር ያስፈልግዎታል?',
    svc_cta_desc: 'ኩባንያችን ለምርት ምርጫ እና ለሥራ ወጪ ግምት ዝግጁ ነው።',
    svc_cta_btn: 'ያነጋግሩን',
    svc_import_origin: 'ከውጭ',
    svc_local_origin: 'አካባቢያዊ',
    svc_cat_import: 'ከውጭ የሚገቡ አሉሚኒየም ፕሮፋይሎች',
    svc_cat_local: 'በአገር ውስጥ የሚመረቱ አሉሚኒየም ፕሮፋይሎች',
    svc_cat_glass: 'የሕንፃና ዲኮር መስታወቶች (ብርጭቆዎች)',
    svc_cat_acp: 'አሉሚኒየም ኮምፖዚት ፓናል (ACP)',
    svc_cat_acc: 'አሉሚኒየም መጋጠሚያዎችና ተጓዳኝ ዕቃዎች',
    svc_cat_rail: 'የእጅ መደገፊያዎች (ሬሊንግ)',
    svc_cat_steel: 'ስቴይንለስ ስቲል',

    // Products
    prod_eyebrow: 'የምርት ዝርዝር',
    prod_title: 'ምርቶቻችን',
    prod_tagline: 'ሁሉንም አሉሚኒየም ፕሮፋይሎቻችን፣ መስታወቶች፣ ፓናሎች እና ተጓዳኝ ዕቃዎቻችን ዳስሱ።',
    ...
    gal_eyebrow: 'ሥራዎቻችን',
    gal_title: 'ፎቶ ማዕከል',
    gal_tagline: 'KS Aluminium ፕሮጀክቶች፣ ሙያዊ ሥራዎች እና የሥራ ሂደቶች ፎቶ ስብስብ።',
    gal_photos: 'ፎቶዎች',
    gal_videos: 'ቪዲዮዎች',
    gal_all: 'ሁሉም',
    gal_cta_title: 'ለፕሮጀክትዎ ምክር ጠይቁ',
    gal_cta_desc: 'ኩባንያችን ቢሾፍቱ፣ አዲስ አበባ እና አቅራቢያ ከተሞችን ለማስዋብ ዝግጁ ነው።',
    gal_cta_btn: 'ያግኙን',

    // Contact
    contact_eyebrow: 'ያነጋግሩን',
    contact_title: 'አግኙን',
    contact_tagline: 'ከሰኞ እስከ ቅዳሜ ዝግጁ ነን። ስለ አሉሚኒየምና መስታወት ፍላጎቶችዎ ያነጋግሩን።',
    contact_info_title: 'የድርጅቱ ዝርዝር',
    contact_address_label: 'አድራሻ',
    contact_address: 'ቢሾፍቱ (ደብረዘይት)፣ ኦሮሚያ፣ ኢትዮጵያ',
    ...
    contact_map_link: 'ካርታ ከፍተው ይመልከቱ',
    contact_social: 'ይከተሉን',

    // Footer
    footer_about: 'ለኢትዮጵያ ታዋቂ የሆነ ከፍተኛ ጥራት ያለው አሉሚኒየም፣ መስታወቶች፣ ACP ፓናሎች እና ተጓዳኝ ዕቃዎች አቅራቢ።',
